...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/input-group relative flex min-h-11.5 w-full min-w-0 items-center overflow-hidden rounded-xl border border-transparent bg-foreground/[.045] shadow-[inset_0_1px_0_color-mix(in_oklch,var(--background)_72%,transparent),inset_0_-1px_0_color-mix(in_oklch,var(--foreground)_7%,transparent)] transition-[border-color,box-shadow,background-color] duration-300 ease-[cubic-bezier(.16,1,.3,1)] hover:border-foreground/10 hover:bg-foreground/[.065] focus-within:border-foreground/14 focus-within:bg-background focus-within:shadow-[inset_0_-2px_0_var(--primary),0_14px_34px_-24px_var(--foreground)] has-[[aria-invalid=true]]:border-destructive/35 has-[[aria-invalid=true]]:shadow-[inset_0_-2px_0_var(--destructive)] has-[[data-align=block-start]]:flex-wrap has-[[data-align=block-end]]:flex-wrap",
        className,
      )}
      {...props}
    />

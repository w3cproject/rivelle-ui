...
const features = [
  {
    ...
    description: "Every component lands in your codebase. Read it, reshape it, make it unmistakably yours.",
  },
  {
    icon: Layers3,
    title: "Server-first by default",
    description: "No client boundary unless interaction truly needs one. Built for modern Next.js applications.",
  },
  {
    icon: Sparkles,
    title: "Quietly expressive",
    description: "Purposeful motion, tactile states and strong defaults without visual noise.",
  },
]
...
export default function Home() {
  return (
    <main className="relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/75 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center px-5 sm:px-8">
          ...
          <nav className="ml-auto hidden items-center gap-7 text-sm text-muted-foreground md:flex">
            <a className="nav-link" href="/docs/components">Components</a>
      ...
      <section className="relative mx-auto max-w-7xl px-5 pb-24 pt-20 sm:px-8 sm:pb-32 sm:pt-28" id="top">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="reveal-up delay-3 mx-auto mt-9 flex max-w-xl flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Button asChild className="w-full sm:w-auto" size="lg">
              <a href="/docs/components">Explore components <ArrowRight /></a>
            </Button>
            <Button asChild className="w-full sm:w-auto" size="lg" variant="outline">
              <a href="#install"><Code2 /> Get started</a>
            </Button>
          </div>
        ...
        <div className="float-panel mx-auto mt-20 max-w-5xl">
          <div className="flex items-center gap-2 border-b border-border/70 px-4 py-3">
            ...
            <span className="ml-3 text-xs text-muted-foreground">rivelle / button.tsx</span>
          </div>
          <div className="grid md:grid-cols-[1.1fr_0.9fr]">
            <div className="showcase-grid flex min-h-72 items-center justify-center border-b border-border/70 p-8 md:border-b-0 md:border-r">
              <div className="flex flex-col items-center gap-4">
                <Button size="lg"><Sparkles /> Create something</Button>
            ...
            <div className="code-window min-w-0 p-6 font-mono text-[13px] leading-7">
              <p><span className="code-purple">import</span> {"{ Button }"} <span className="code-purple">from</span></p>
              <p className="pl-4 code-green">&quot;@/components/ui/button&quot;</p>
              <p className="mt-4"><span className="code-purple">export default function</span> <span className="code-blue">Page</span>() {"{"}</p>
              <p className="pl-4"><span className="code-purple">return</span> (</p>
              <p className="pl-8">&lt;<span className="code-blue">Button</span> <span className="code-amber">variant</span>=<span className="code-green">&quot;outline&quot;</span>&gt;</p>
              <p className="pl-12 text-foreground">Create something</p>
              <p className="pl-8">&lt;/<span className="code-blue">Button</span>&gt;</p>
              <p className="pl-4">)</p>
              <p>{"}"}</p>
            </div>
          </div>
      ...
      <section className="border-y border-border/70 bg-card/35" id="principles">
        <div className="mx-auto grid max-w-7xl divide-y divide-border/70 px-5 sm:px-8 md:grid-cols-3 md:divide-x md:divide-y-0">
          {features.map(({ icon: Icon, title, description }) => (
            <div className="feature-item py-10 md:px-8 md:first:pl-0 md:last:pr-0" key={title}>
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 sm:px-8 sm:py-32" id="components">
        <div className="mb-12 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          <div>
            <Badge variant="outline"><Blocks /> The collection</Badge>
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          >
            ...
            <Button size="icon"><MousePointer2 /></Button>
          </ComponentPreview>
          ...
          >
            <div className="w-full max-w-sm space-y-3">
              ...
              <Textarea className="min-h-20" placeholder="Tell us what you are building…" />
            </div>
          </ComponentPreview>
          ...
          >
            <div className="w-full max-w-xs rounded-xl border bg-background/80 p-4 shadow-sm">
              <div className="flex items-center justify-between gap-4">
                <div><p className="text-sm font-medium">Product updates</p><p className="text-xs text-muted-foreground">A thoughtful note, occasionally.</p></div>
                <Switch defaultChecked />
              </div>
              <Separator className="my-4" />
              <div className="flex items-center justify-between gap-4">
                <div><p className="text-sm font-medium">Usage insights</p><p className="text-xs text-muted-foreground">Weekly performance digest.</p></div>
                <Switch />
              </div>
            </div>
          </ComponentPreview>
          ...
          >
            <Card className="w-full max-w-md hover:-translate-y-1">
              <CardHeader>
                <div className="flex items-center justify-between"><Badge variant="success">Active</Badge><Zap className="size-4 text-primary" /></div>
                <CardTitle className="pt-3 text-xl">Launch faster, stay in control.</CardTitle>
                <CardDescription>Start with a considered foundation and change every detail as your product evolves.</CardDescription>
              </CardHeader>
              <CardContent><Separator /></CardContent>
              <CardFooter className="justify-between"><span className="text-sm text-muted-foreground">Source included</span><Button size="sm">View source <ArrowRight /></Button></CardFooter>
            </Card>
          </ComponentPreview>
        </div>
      </section>

      <section className="mx-auto max-w-7xl px-5 pb-24 sm:px-8 sm:pb-32" id="install">
        <div className="install-panel relative overflow-hidden rounded-3xl border p-7 sm:p-12 lg:p-16">
          ...
          <div className="relative z-10 grid gap-12 lg:grid-cols-[1fr_0.85fr] lg:items-center">
            <div>
              <Badge className="border-white/10 bg-white/10 text-white" variant="outline">Ready when you are</Badge>
              <h2 className="mt-6 max-w-xl text-4xl font-semibold tracking-[-0.045em] text-white sm:text-6xl">One command. Your code.</h2>
              <p className="mt-5 max-w-xl text-base leading-relaxed text-white/60">Initialize the tokens, add only what you need, then build without fighting someone else&apos;s abstraction.</p>
            </div>
            <div className="space-y-3">
              <CopyCommand command="pnpm dlx rivelle@latest init" />
              <CopyCommand command="pnpm dlx rivelle@latest add button" />
              <p className="pt-2 text-center text-xs text-white/40">React · Next.js · Tailwind CSS v4 · TypeScript</p>
            </div>
          </div>
        </div>
      </section>

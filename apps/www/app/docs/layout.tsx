      ...
      <header className="docs-header">
        <div className="docs-header-inner">
          ...
          <div className="docs-header-actions">
            <button className="docs-global-search" type="button"><Search /><span>Search documentation...</span><kbd>⌘ K</kbd></button>
            <Button aria-label="GitHub" size="icon-sm" variant="ghost"><Github /></Button>
            <ThemeToggle />
          </div>
        </div>
      </header>
